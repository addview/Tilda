  ...
  return (
    <SafeAreaView className="bg-fuchsia-200  flex-1 pt-2 pr-2 pl-2">
      ...
      <View className="flex-1 justify-between p-4">
        <View className="pb-2 flex-1 items-center justify-center bg-[#313866] rounded-md">
          <View
            style={{
          ...
          >
            <View>
              <TouchableOpacity
                ...
                className=" bg-[#FE7BE5] rounded-full   items-center justify-center"
        ...
        <View className="mb-4 flex-1 items-center justify-center bg-[#974EC3] rounded-md">
        ...
        <View className="flex-1 items-center justify-center  bg-[#504099] rounded-md">
          <View className="flex flex-row justify-evenly w-full">
            <View>
              <TouchableOpacity
                className=" bg-[#FE7BE5] rounded-full h-20 w-20  items-center justify-center"
        ...
        <View className="m-2 p-2  items-center justify-center ">
          <TouchableOpacity
            className="p-4 bg-[#c32da7] rounded-md items-center justify-center"
            onPress={() => fetchData()}
          >
            <Text className="text-white text-md font-bold">Uppdatera</Text>
          </TouchableOpacity>
        </View>
      </View>
